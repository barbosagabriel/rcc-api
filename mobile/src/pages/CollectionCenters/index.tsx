...
const CollectionCenters = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if (status !== "granted") {
        Alert.alert("Ops!", "We need your permission to get your location");
        return;
      }
  ...
  function handleNavigateToDetail(id: number) {
    navigation.navigate("CenterDetail", { centerId: id });
  }
  ...
  return (
    <>
      <View style={styles.container}>
        ...
        <Text style={styles.description}>Find in map a collection center.</Text>
            ...
            >
              {collectionCenters.map((center) => (
                <Marker
                  ...
                  onPress={() => handleNavigateToDetail(center.id)}
                  coordinate={{
